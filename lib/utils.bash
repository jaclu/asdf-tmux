...
install_version() {
    ...
    # shellcheck disable=SC2310 # check_dependencies returns true/false
    ...
    (
        # 2154 - the ASDF_DOWNLOAD_PATH defined via asdf
        # SC2310 - the function never returns failure, it exits on error
